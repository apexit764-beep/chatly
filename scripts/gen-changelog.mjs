...
const BUILD_LIVE = 'd469bcf6-a7c9-415d-a1a5-5fd6a4c6eb36';

const ENTRIES = [
  {
    id: 16,
    date: '13 سبتمبر 2026',
    title: 'توسعة المسافات حول مؤشّر الباقات',
    ...
    status: 'live',
    points: [
      'قِسْت المنطقة قبل التعديل فطلع السبب تداخلاً فعلياً لا مجرد ضيق: الفقاعة تتعلّق ~35px فوق المسار والسطر فوقها عنده 32px هامش، فكان أعلى الفقاعة يقع 3px داخل أسفل السطر — متراكبين عند كل نقطة.',
      'الهامش تحت سطر «اسحب المؤشّر» صار 56px بدل 32، فتجاوز مدى الفقاعة.',
      'وُسّعت كذلك المسافة تحت العنوان (40px بدل 32)، وتحت مبدّل شهري/سنوي (40 بدل 24)، وبين المؤشّر والجدول (56 بدل 40) — كانت كلها أضيق من إيقاع بقية الصفحة.',
      'القياس بعد التعديل: الفقاعة تبتعد عن السطر 22px عند النقطة الأولى والأخيرة (أسوأ حالتين)، والجدول يبدأ 56px تحت المسار.',
    ],
  },
  {
    id: 15,
