...
export const CHANNEL_TYPES: ChannelTypeMeta[] = [
  ...
  },
  {
    ...
    category: 'communication',
    name: 'TikTok',
    tagline: 'استقبل الرسائل المباشرة من TikTok',
    description:
      'اربط حساب TikTok الخاص بأعمالك لاستقبال الرسائل المباشرة والتعليقات والرد عليها من Qhub. يدعم النص والوسائط.',
    brandColor: '#FE2C55',
    steps: [
      'سجّل الدخول في developers.tiktok.com وأنشئ تطبيقاً جديداً',
      'فعّل صلاحيات Direct Messaging وربط حساب الأعمال',
      'انسخ Client Key و Client Secret و Access Token',
  ...
  },
  {
    ...
    category: 'email',
    name: 'Gmail',
    tagline: 'بريد Google الإلكتروني و Google Workspace',
    description:
      'اربط حساب Gmail أو Google Workspace لإرسال الحملات التسويقية والإشعارات. يستخدم smtp.gmail.com مع كلمة مرور تطبيق (App Password) للاتصال الآمن.',
    brandColor: '#EA4335',
    steps: [
    ...
    identifierPlaceholder: 'name@gmail.com',
    credentials: [
      { key: 'smtpPassword', label: 'كلمة مرور التطبيق (App Password)', placeholder: '••••••••', type: 'password', hint: 'من myaccount.google.com ← Security ← App passwords — وليس كلمة مرور الحساب' },
    ],
  },
  {
    type: 'outlook',
    ...
    tagline: 'بريد Microsoft و Microsoft 365',
    description:
      'اربط حساب Outlook أو Hotmail أو Microsoft 365 لإرسال الحملات والإشعارات. يدعم OAuth عبر Microsoft Graph API أو SMTP المباشر.',
    brandColor: '#0078D4',
    steps: [
    ...
    identifierLabel: 'البريد الإلكتروني',
    identifierPlaceholder: 'name@outlook.com',
    credentials: [
      { key: 'clientId', label: 'Client ID', placeholder: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', type: 'text', hint: 'من Azure ← App registrations ← Application (client) ID' },
      { key: 'clientSecret', label: 'Client Secret', placeholder: '••••••••', type: 'password', hint: 'من Azure ← Certificates & secrets' },
      { key: 'tenantId', label: 'Tenant ID', placeholder: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', type: 'text', hint: 'من Azure ← Overview ← Directory (tenant) ID' },
    ],
  },
  {
    type: 'yahoo',
    category: 'email',
    name: 'Yahoo Mail',
    tagline: 'بريد Yahoo الإلكتروني',
    description:
      'اربط حساب Yahoo Mail لإرسال الحملات والإشعارات عبر SMTP. يتطلب كلمة مرور تطبيق (App Password) مع تفعيل التحقق بخطوتين.',
    brandColor: '#6001D2',
    steps: [
      'فعّل التحقق بخطوتين من account.yahoo.com ← Account Security',
      'أنشئ كلمة مرور تطبيق من Account Security ← Generate app password',
      'أدخل بريدك وكلمة مرور التطبيق في النموذج',
      'سيستخدم النظام smtp.mail.yahoo.com:587 تلقائياً',
    ],
    identifierLabel: 'البريد الإلكتروني',
    identifierPlaceholder: 'name@yahoo.com',
    credentials: [
      { key: 'smtpPassword', label: 'كلمة مرور التطبيق (App Password)', placeholder: '••••••••', type: 'password', hint: 'من Yahoo ← Account Security ← Generate app password' },
    ],
  },
  {
    type: 'smtp',
    category: 'email',
    name: 'بريد آخر (SMTP)',
    tagline: 'أي مزوّد بريد عبر SMTP مخصص',
    description:
      'اربط أي حساب بريد إلكتروني باستخدام بيانات SMTP المخصصة. يدعم iCloud Mail و Zoho و ProtonMail Bridge وأي مزوّد آخر يوفر SMTP.',
    brandColor: '#6B7280',
    steps: [
