...
export const plans: Plan[] = [
  {
    ...
    features: [
      'صندوق وارد موحّد مع إسناد المحادثات',
      'قناة واحدة (واتساب أو ويدجت أو بريد)',
      'جهات الاتصال مع استيراد وتصدير CSV',
      'الردود المحفوظة والوسوم',
      'تقييم العملاء بعد إغلاق المحادثة',
      'تقارير أساسية للمحادثات',
      'الوضع الليلي وواجهة عربية/إنجليزية',
      'تطبيق جوال للموظفين',
  ...
  },
  {
    ...
    features: [
      'كل مزايا باقة المبتدئ',
      'المساعد الذكي (Claude · OpenAI · Gemini) بردود تلقائية',
      'لهجات ونبرة مخصصة لردود المساعد',
      'الحملات التسويقية مع الجدولة والقوالب',
      'قنوات التواصل: Messenger وInstagram وTelegram وTikTok',
      'قاعدة المعرفة لتغذية المساعد الذكي',
      'تقارير تفصيلية مع فلترة حسب الحساب المربوط',
      'الردود التلقائية والـ Webhooks وربط Zapier',
  ...
  },
  {
    ...
    features: [
      ...
      'الأقسام والتوزيع الذكي للمحادثات',
      'الأدوار والصلاحيات التفصيلية لكل موظف',
      'Live Chat Widget بإعدادات مستقلة لكل موقع',
      'إعدادات تقييم مستقلة لكل حساب مربوط',
      'ربط متاجر سلة وزد وShopify وWooCommerce',
      'كل التكاملات (Slack · Telegram · TikTok · Webhook)',
      'الشكاوى والاقتراحات وتقييمات العملاء التفصيلية',
      'API كامل بدون حدود',
  ...
  },
  {
    ...
    features: [
      ...
      'مدير حساب مخصص (CSM)',
      'تدريب مجاني للفريق',
      'سياسات أمان مُلزمة (مصادقة ثنائية وتقييد IP)',
...
// =====================================================================
// Plan Requests — enterprise enquiries from the client portal
// =====================================================================
export const planRequests: PlanRequest[] = [
  {
    id: 'preq_1', clientId: 'client_1', planId: 'plan_enterprise',
    name: 'أحمد العتيبي', company: 'Speed Delivery',
    email: 'ahmed@speed-delivery.com', phone: '201100000000', countryCode: 'EG',
    requestedAgents: 220, requestedChannels: 14, status: 'new', createdAt: nowMinus(90),
    message: 'عندنا 4 فروع وفريق دعم يشتغل 24/7، محتاجين SLA مضمون ومدير حساب مخصص.',
  },
  {
    id: 'preq_2', clientId: 'client_3', planId: 'plan_business',
    name: 'سارة المنصوري', company: 'بوسطة للشحن السريع',
    email: 'sara@bostaa.com', phone: '9661125395165', countryCode: 'SA',
    requestedAgents: null, requestedChannels: null, status: 'new', createdAt: nowMinus(260),
    message: 'نحتاج ربط واتساب وانستغرام مع توزيع تلقائي على الأقسام.',
  },
  {
    id: 'preq_3', clientId: 'client_2', planId: 'plan_enterprise',
    name: 'خالد البلوشي', company: 'مجموعة الخليج التجارية',
    email: 'khalid@gulfgroup.om', phone: '96899123456', countryCode: 'OM',
    requestedAgents: 300, requestedChannels: 20, status: 'new', createdAt: nowMinus(60 * 9),
  ...
  },
  {
    ...
    message: 'عندنا متجر سلة ومحتاجين نربطه مع المحادثات.',
  },
  {
    id: 'preq_5', clientId: 'client_4', planId: 'plan_enterprise',
    name: 'يوسف القحطاني', company: 'شركة البنيان للمقاولات',
    email: 'y.qahtani@bunyan.sa', phone: '966555443322', countryCode: 'SA',
    requestedAgents: 120, requestedChannels: 8, status: 'new', createdAt: nowMinus(60 * 30),
    message: '',
  },
  {
    id: 'preq_6', clientId: 'client_1', planId: 'plan_enterprise',
    name: 'ليلى النعيمي', company: 'صيدليات الشفاء',
    email: 'layla@shifa-pharma.qa', phone: '97455667788', countryCode: 'QA',
    requestedAgents: 80, requestedChannels: 12, status: 'contacted', createdAt: nowMinus(60 * 52),
    message: 'تم إرسال عرض السعر، بانتظار موافقة الإدارة.',
  },
  {
    id: 'preq_7', clientId: 'client_2', planId: 'plan_business',
    name: 'عمر الزعبي', company: 'أكاديمية نور',
    email: 'omar@noor-academy.jo', phone: '962791234567', countryCode: 'JO',
    requestedAgents: null, requestedChannels: null, status: 'contacted', createdAt: nowMinus(60 * 70),
    message: 'اتفقنا على تجربة 14 يوم قبل الاشتراك.',
  },
  {
    id: 'preq_8', clientId: 'client_3', planId: 'plan_enterprise',
    name: 'فهد الصباح', company: 'الوطنية للاتصالات',
    email: 'fahad@wataniya.kw', phone: '96599887766', countryCode: 'KW',
